    ...
    export class Msg {
        public static encode(ba:egret.ByteArray, field:any, arrPara?) {
            if (field instanceof byte) {
                ...
                let fieldBa:egret.ByteArray = field.encode();
        ...
        public static decode(ba, type:string, arrLength?:number):any {
            if (arrLength != null) {
                ...
                let result = this.getMsgInstance("sgame." + type);
                result.decode(ba);
                return result;
            }
        }
        ...
        public static getMsgInstance(name:string):any {
            let msgName = MsgModel.msgDic[name];
            if (msgName == null) {
                ...
                let cls = egret.getDefinitionByName(msgName);
                return new cls();
            }
        }
        ...
        public static encodeInt64(ba:egret.ByteArray, num:int64):void {
            let tempBa:egret.ByteArray = new egret.ByteArray();
            if (num.sign) {
